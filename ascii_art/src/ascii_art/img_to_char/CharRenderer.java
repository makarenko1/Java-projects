...
public class CharRenderer {
    ...
    private static final char CHAR_FOR_TRUE = ' ';  // the character to print for the true value.
    private static final char CHAR_FOR_FALSE = '#';  // the character to print for the false value.
    ...
    /*
     * Renders the given character. Returns the boolean array that represents the given character, where
     * true corresponds to white color, false to black. Is a helper method for the getImg method.
     */
    ...
    // for debugging.
    /**
     * Prints the given boolean array. For every true value in the array prints the CHAR_FOR_TRUE character,
     * for every false value prints the CHAR_FOR_FALSE character.
     * @param arr the array of boolean values that represents a character.
     */
    public static void printBoolArr(boolean[][] arr) {
        for (boolean[] row : arr) {
            for (boolean charBooleanValue : row) {
                if (charBooleanValue) {
                    System.out.print(CHAR_FOR_TRUE);
                } else {
                    System.out.print(CHAR_FOR_FALSE);
                }
            }
            System.out.println();
        }
