...
/**
 * Calculates the random values for the y-values in the Terrain class.
 */
public class PerlinNoise {
    ...
    /*
     * Initializes and populates the permutations array.
     */
    private void init() {
    ...
    /**
     * Calculates a random value by x.
     * @param x the value to calculate by.
